...
import { faBars, faLocationDot, faMagnifyingGlass, faShoppingCart, faUser } from '@fortawesome/free-solid-svg-icons'

const Header = () => {
  return (
    <div className='px-16 xl:px-24 w-full bg-gradient-to-b from-[#0006] to-transparent'>

        <nav className='flex justify-between h-24 xl:border-b-2'>
        ...
        <div>
          <ul className='flex h-full'>
            ...
            <li className='p-4 h-full flex items-center cursor-pointer border-b-[4px] border-t-[4px] border-transparent hover:border-b-[#1c69d4] xl:hidden'><FontAwesomeIcon icon={faBars} style={{color: "#ffffff",}} size='xl' /></li>
          </ul>
        </div>
        </nav>
